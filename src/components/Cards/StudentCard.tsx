...
const StudentCard: React.FC<StudentCardProps> = ({ student, order }) => {
  return (
    <div className="w-full bg-white h-[68px] flex items-center rounded-lg mb-3 pl-4 hover:bg-slate-200">
      ...
      <h3 className="text-[#1D1D1F] font-medium ml-[33px] text-[15px] w-[155px]">
        {student.full_name}
      </h3>
      <h3 className="mx-4 w-[150px] text-[14px] font-normal text-[#1D1D1F] text-center">
        {student.type === 1
          ? "Bakalavr"
          : student.type === 2
          ? "Magistr"
      ...
      <h3 className="font-normal text-[#1D1D1F] w-[320px] text-[14px] text-center">
